export default [
  ...
  [
    [
      "norugjhgwqxrdrihwtwdfgi",
      "ykywlzmiplhhvwpbvimczuzecl",
      "rqindmyp",
      "pkzwttxpyrjfyhmlhehjd",
    ],
    [
      [1, 2],
      [1, 2],
  ...
  [
    [
      ...
      "sg",
      "gfiufm",
      "wnyvvgqucyjyrcsptzjvawvjfzfnlajg",
      "ctnydlvnhwynaiwss",
      "jxiimicjpevzuulpeorvhfoizdumoce",
      "bk",
      "ezpbrhqni",
      "qlalpzdvcvsiggfzhbvmbnderrrhpxercsyr",
      "prunwbhfusmtd",
      "dqtpiczphvmmebkjymee",
      "yliexnoxitlmipdpgq",
      "hvbmmyuos",
      "duksgf",
      "suwqmrauuuacqqvznlbtqopzzphekllpwjb",
      "jrxdyvtebhmfscsdwovkosnk",
      "cic",
      "awqdbvynrjlfmuehgwwtxskhihicdgiycxwmbm",
      "stipidhjxuktfsairr",
    ],
    [
      [11, 11],
  ...
  [
    [
      "qysocue",
      "axnisoxgsdkujhjjadtsqddmmda",
      "vwervizcudgedrguu",
      "uzoaikzkhuxbzszqara",
      "rzvuejyncmwpbhs",
      "gap",
      "ekpvxaowewrpzzjdukewfr",
      "tawetkkelzvtqfbyxaxtceegx",
      "ismdpgsjnmqyfhrkaaoyhvarkno",
    ],
    [
      [4, 8],
      [7, 8],
